...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/BIRDSHOT Workflow.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{Sup_figures/selection_pipeline.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.9\linewidth]{Sup_figures/compositional_space_size.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.9\linewidth]{Sup_figures/fcc_filtering.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.9\linewidth]{Figures/perturbation_analysis_v2.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.9\linewidth]{Sup_figures/subsystem_counts.pdf}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/BBA_Suggestions_v2.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\columnwidth]{Figures/file_structure.pdf}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{Sup_figures/Property_Pair_Plot.pdf}
